<div class="modal fade" id="newGroup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <h5 class="modal-title" id="exampleModalLabel">Бүлэг нэмэх</h5>
        ...
        <div class="modal-body">
            <div class="form-group">
                <label for="cmbRank" class=" form-control-label"><b>Дүрэм</b></label>
                    <select name="cmbRule" id="cmbRules" class="form-control valid">
                ...
                <input class="form-control" id="txtGroup" placeholder="Бүлгийн нэршил оруулна уу!"/>
            <div class="modal-footer">
                <button type="button" style="border-radius: 50px 0px 50px 0px; padding-left: 50px; padding-right: 50px" post-url="{{url("/group/store")}}" id="btnSaveRule" class="btn btn-success">Хадгалах</button>
